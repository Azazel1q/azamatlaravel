<header>
    <div class="logo-light">WorkIng</div>
    <div class="dropdown-menu" id="burger_button">
        <svg class="dropdown-menu__svg-light" fill="#ffffff" width="50px" height="50px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
